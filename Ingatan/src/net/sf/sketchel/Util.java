...
public class Util {
    ...
    public static int iround(float V) {
    ...
    public static int norm2(int x, int y) {
        return x * x + y * y;
    }
    ...
    public static double norm2(double x, double y, double z) {
        return x * x + y * y + z * z;
    }
    ...
    public static float norm2(float x, float y, float z) {
        return x * x + y * y + z * z;
    }
    ...
    public static boolean fltEqual(float v1, float v2) {
        return v1 == v2 || Math.abs(v1 - v2) <= 1E-6 * Math.max(v1, v2);
    }

    public static boolean dblEqual(double v1, double v2) {
    ...
    public static String intrpad(int val, int len) {
        return intrpad(val, len, ' ');
    }
    ...
    public static JMenuItem menuItem(ActionListener lstn, String txt, int key) {
        return menuItem(lstn, txt, key, null, null);
    }

    public static JMenuItem menuItem(ActionListener lstn, String txt, int key, Icon icon) {
        return menuItem(lstn, txt, key, icon, null);
    }
    ...
    public static JButton makeButton(ActionListener lstn, String text) {
        return makeButton(lstn, text, 0, null);
    }

    public static JButton makeButton(ActionListener lstn, String text, int key) {
        return makeButton(lstn, text, key, null);
    }

    public static JButton makeButton(ActionListener lstn, String text, int key, String toolTip) {
        JButton btn = new JButton(text);
        if (lstn != null) {
            btn.addActionListener(lstn);
        }
        if (key != 0) {
            btn.setMnemonic(key);
        }
    ...
    public static JRadioButton makeRadio(ActionListener lstn, String text, ButtonGroup bg) {
        return makeRadio(lstn, text, bg, 0, null);
    }

    public static JRadioButton makeRadio(ActionListener lstn, String text, ButtonGroup bg, int key) {
        return makeRadio(lstn, text, bg, key, null);
    }
    ...
    public static JRadioButton makeRadio(ActionListener lstn, String text, ButtonGroup bg, int key, String toolTip) {
        ...
        if (toolTip != null) {
            rad.setToolTipText(toolTip);
        }
        if (lstn != null) {
            rad.addActionListener(lstn);
        }
        return rad;
    }
    ...
    public static int javaVersion() {
        ...
        if (!m.find()) {
            throw new RuntimeException("Unable to parse Java version: '" + verstr + "'");
        }

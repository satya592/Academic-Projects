...
public class ToolCursors
{
	...
	{
		null,
		"/net/sf/sketchel/images/CursorDelete.gif",
		"/net/sf/sketchel/images/CursorSmallBox.gif",
		"/net/sf/sketchel/images/CursorSmallCircle.gif",
		"/net/sf/sketchel/images/CursorBondSingle.gif",
		"/net/sf/sketchel/images/CursorBondDouble.gif",
		"/net/sf/sketchel/images/CursorBondTriple.gif",
		"/net/sf/sketchel/images/CursorBondZero.gif",
		"/net/sf/sketchel/images/CursorBondInclined.gif",
		"/net/sf/sketchel/images/CursorBondDeclined.gif",
		"/net/sf/sketchel/images/CursorBondUnknown.gif",
		"/net/sf/sketchel/images/CursorPlusMinus.gif",
		"/net/sf/sketchel/images/CursorPan.gif"
	};
	...
	private static void generateCursor(int idx,String annot,int ax,int ay)
	{
		...
		if (idx==CURSOR_POINTER) {Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR); return;}

...
public class DialogEdit extends JDialog implements ActionListener
{
	...
	public DialogEdit(Frame parent,Molecule Mol,ArrayList<Integer> SelIdx)
	{
		...
		atoms=new JTable(compileAtomData(),new String[]{"#","El","X","Y","Charge","Unpaired","Isotope","HExplicit","MapNum"})
		...
		atoms.setPreferredScrollableViewportSize(new Dimension(500,200));

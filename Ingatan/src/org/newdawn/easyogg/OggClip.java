...
public class OggClip {
    ...
    /**
     * Any added action listeners will be fired when playback stops.
     */
    ...
    private void playStream(Thread me) throws InternalException {
        ...
        while (true) {
            ...
            for (int s = 0; s < actionListeners.size(); s++) {
                actionListeners.get(s).actionPerformed(null);
                System.out.println("THITIHH");
            }

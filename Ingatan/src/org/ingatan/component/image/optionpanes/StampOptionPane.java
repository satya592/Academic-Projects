...
import org.ingatan.component.image.*;
 ...
 * @version 1.0
 */
public class StampOptionPane extends JPanel implements OptionPane {
     ...
     */
    protected BufferedImage mostRecentlySelectedImage;

    /**
     * Creates a new <code>ImageCollectionBrowser</code>.
     */
    public StampOptionPane() {

        //instantiate components.
        comboCategories = new JComboBox();
        thumbnailPane = new ThumbnailPane(40, 3);
        ...
        if (comboCategories.getItemCount() > 0) {
            ...
            try {
                ...
                Logger.getLogger(StampOptionPane.class.getName()).log(Level.SEVERE, "While loading the thumbnail pane for the first category.", ex);
            }
        }
    }
    ...
    private class ThumbnailMouseListener implements MouseListener {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            mostRecentlySelectedImage = getSelectedImage();
        }
    ...
    protected BufferedImage getSelectedImage() {
        try {
            ...
            Logger.getLogger(StampOptionPane.class.getName()).log(Level.SEVERE, "Could not load the currently selected collections image. "
    ...
    private void generateCategories() {
        ...
        if (collectionsPath.exists()) {
            ...
            Logger.getLogger(StampOptionPane.class.getName()).log(Level.WARNING, "Collections path does not exist, should have been created at IOManager initialisation.");
        }
    }
    ...
    protected class CategoryComboActionListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                Logger.getLogger(StampOptionPane.class.getName()).log(Level.SEVERE, "While loading the thumbnail pane due to change of category.", ex);
            }
        }
    }
     ...
     * @return the currently selected stamp;
     */
    public BufferedImage getSelectedStamp() {
        return mostRecentlySelectedImage;
    }

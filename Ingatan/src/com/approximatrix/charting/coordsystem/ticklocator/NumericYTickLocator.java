...
public class NumericYTickLocator extends NumericTickLocator {
	 ...
	 */
	public NumericYTickLocator(double max, double min, int numTicsDesired,
			int maxTics) {
	 ...
	 */
	public NumericYTickLocator(double max, double min, int numTicsDesired,
			int maxTics, boolean force_simple) {

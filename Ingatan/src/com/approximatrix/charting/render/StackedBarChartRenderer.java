...
import com.approximatrix.charting.model.StackedChartDataModelConstraints;
...
public class StackedBarChartRenderer extends AbstractChartRenderer {
    ...
    public boolean renderChart(Graphics2D g) {
        ...
        for(int j = 0; j < maximumDataSetLength && !this.getStopFlag(); j++) {
            double minvalue = 0.0;
            double maxvalue = 0.0;
            ...
            for(int i = 0; i < m.getDataSetNumber() && !this.getStopFlag(); i++) {
